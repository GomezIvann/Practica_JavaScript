        ...
        $.ajax({
            ...
            success: function(datos){
                    ...
                    var stringDatos =  "<h3>" + ciudad + "</h3>";
                        ...
                        stringDatos += "<img src=http://openweathermap.org/img/w/" + icono + ".png />";    
                
                    $("p").append(stringDatos);                  
                },
            error:function(){
                    $("h3").html("¡Tenemos problemas! No se pudo obtener el XML de <a href='http://openweathermap.org'>OpenWeatherMap</a>");
                    $("h2").remove();
                    $("p").remove();
                }
        });
